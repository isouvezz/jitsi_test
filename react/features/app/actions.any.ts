...
export function redirectWithStoredParams(pathname: string) {
    return (dispatch: IStore["dispatch"], getState: IStore["getState"]) => {
        ...
        // Check if there's a previousUrl in the hash params
        const params = new URLSearchParams(newLocationURL.hash.substring(1));
        const previousUrl = params.get("config.previousUrl");
